...
const wineProfiles = [
  ...
  },
  {
    ...
    ariaLabel: 'Spätburgunderflasche mit goldenem Dating-Profil-Hintergrund',
    verified: '✓ Fast Finalist',
    bio: 'Ich war mal ganz vorne dabei, bin aber heute nur der charmante Ablenkungswein. Elegant genug zum Verführen, gefährlich genug für falsche Sicherheit.',
    tags: ['🍒 elegant', '✨ ausgewogen', '🎭 Ablenkung', '🥈 knapp daneben'],
    details: {
      Job: 'Finalisten-Double',
      Wohnort: 'Zweite Reihe im Gewinnerglas',
      Sucht: 'Aufmerksame Verkoster:innen mit Restzweifel',
      'Red Flag': 'Sieht verdächtig richtig aus',
    },
    prompt: '„Ich wirke wie die Lösung, bin aber nur sehr überzeugend angezogen.“',
  },
  {
    ...
    bio: 'Ich heiße Illusion, bin Jahrgang 2022 und trotzdem die Wahrheit im Glas: weiß gekelterter Spätburgunder von der Ahr, frisch, mineralisch und charmant genug, um Rotwein-Fans kurz die Realität neu zu erklären.',
    tags: ['🥂 Blanc de Noir', '🍐 Birne', '🍎 Apfel', '🍑 Pfirsich', '🍋 Zitrone'],
    details: {
      Herkunft: 'Weingut Meyer-Näkel, Ahr',
      Stil: 'Spätburgunder Blanc de Noir · VDP.Gutswein',
      Rebsorte: 'weiß gekelterter Spätburgunder',
      Sucht: 'Frische, Mineralität und erstaunte Blicke',
      'Red Flag': 'Tut weiß, denkt aber heimlich in Pinot',
      Motto: 'Ich bin keine Täuschung. Ich bin die Pointe.',
    },
    prompt: '„Rate ruhig Rotwein. Ich liebe diesen Moment.“',
  },
];
