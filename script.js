...
const wineProfiles = [
  ...
  },
  {
    ...
    isCorrect: false,
    match: '91% Match',
    title: 'Du Neuf en Gascogne, 2025',
    label: 'Du Neuf\n9 %',
    image: 'assets/profiles/du-neuf-gascogne.png',
    photoPosition: 'center 42%',
    ariaLabel: 'Du Neuf en Gascogne Profilbild mit Colombard-Weinflasche',
    verified: '✓ Terrassen-Leichtgewicht',
    bio: 'Ich bin der französische Terrassenwein, der mit 9 % Alkohol reinkommt wie „nur kurz Hallo“ und dann mit Grapefruit, Zitrus und guter Laune den ganzen Abend moderiert.',
    tags: ['🍋 Zitrus-Charme', '🍊 Grapefruit-Gossip', '🪶 9 %-Leichtgewicht', '🐟 Fisch-Flirt', '⛱️ Terrassenmodus'],
    details: {
      Herkunft: 'Côtes de Gascogne IGT, Frankreich',
      Stil: 'Colombard · feinherb/halbtrocken · 9 %',
      Beruf: 'Aperitif mit Sommervertrag',
      Sucht: 'Salate, gegrillten Fisch und Sonnenbrillen-Komplimente',
      'Red Flag': 'Sagt „leicht und trinkig“ und ist plötzlich leer',
      Motto: 'Sensorisch voll auf die 12, alkoholisch nur auf die 9.',
    },
    prompt: '„Ich bin nicht kompliziert, ich bin nur sehr gut gekühlt und gefährlich sympathisch.“',
  },
  {
    id: 'mueller-thurgau-dino-magnum',
    isCorrect: false,
    match: '93% Match',
    title: 'Müller-Thurgau-Dino Magnum, 2022',
    label: 'Dino\nMagnum',
    image: 'assets/profiles/mueller-thurgau-dino-magnum.png',
    photoPosition: 'center 42%',
    ariaLabel: 'Müller-Thurgau-Dino Magnum Profilbild mit Magnum-Weinflasche',
    verified: '✓ Magnum-Saurus',
    bio: 'Ich bin 1,5 Liter Müller-Thurgau und damit kein Glas, sondern ein soziales Ereignis. Feingliedrig, fruchtig und großformatig genug, um beim Picknick die Moderation zu übernehmen.',
    tags: ['🦖 Magnum-Dino', '🍐 Birnen-Blick', '🍑 Aprikosen-Agenda', '🌿 Kräuter-Kante', '🧂 salzig-mineralisch'],
    details: {
      Herkunft: 'Weingut Strub, Rheinhessen',
      Stil: '100 % Müller-Thurgau · trocken · 12,5 %',
      Format: '1,5 l Magnum mit Gesprächsbedarf',
      Sucht: 'Sommerabende, große Gläser und kleine Ausreden',
      'Red Flag': 'Kommt als Magnum und sagt trotzdem „ich bin unkompliziert“',
      Motto: 'Schlanker Körper, großes Auftreten.',
    },
    prompt: '„Ich bringe Birne, Aprikose und doppelte Flaschengröße. Du bringst bitte genug Leute mit.“',
  },
  {
    id: 'kolonne-null-riesling',
    isCorrect: false,
    match: '88% Match',
    title: 'Kolonne Null Riesling, 2025',
    label: 'Kolonne\nNull',
    image: 'assets/profiles/kolonne-null-riesling.png',
    photoPosition: 'center 42%',
    ariaLabel: 'Kolonne Null alkoholfreier Riesling Profilbild mit Weinflasche',
    verified: '✓ 0,0 % Drama',
    bio: 'Ich bin Riesling ohne Alkohol, aber mit genug Schieferkante, um trotzdem eine Meinung zu haben. Mirabelle, Quitte und null Promille: der Wein für alle, die morgen noch wissen wollen, wem sie zugeprostet haben.',
    tags: ['🚫 0,0 %', '🍑 Mirabellen-Move', '🍐 Quitten-Quote', '🪨 Schieferkante', '🌱 Bio & vegan'],
    details: {
      Herkunft: 'Deutschland · Lösslehm & Schiefer',
      Stil: 'Riesling · alkoholfrei · 0,0 %',
      Beruf: 'Katerfreier Gesprächsstarter',
      Sucht: 'Aperitif-Momente ohne Ausreden am nächsten Morgen',
      'Red Flag': 'Sagt „ich trinke heute nicht“ und flirtet trotzdem im Glas',
      Motto: 'Null Alkohol, volle Nebenhandlung.',
    },
    prompt: '„Ich mache dich nicht mutiger, nur aromatisch überzeugter.“',
  },
  {
